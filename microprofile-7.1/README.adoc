...
== Plan Review
The Specification Committee Ballot concluded successfully on The Specification Committee Ballot concluded successfully on YYYY-MM-DD with the results documented in the https://www.eclipse.org/lists/microprofile-wg/msg02726.html[microprofile-wg mailing list].
